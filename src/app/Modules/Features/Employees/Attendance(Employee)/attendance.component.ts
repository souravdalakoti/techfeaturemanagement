...
export class AttendanceComponent {
    ...
    getactivity(date: any) {
        ...
        this.service.activitylistbydate(model).subscribe((result) => {
            debugger
            this.date_wise_activity = result;
            var datetime = (new Date(this.date_wise_activity[0].date).toDateString()).split(" ", 4);
    ...
    getactivityrecordlist() {
        ...
        this.service.activitylist(res).subscribe((result) => {
            debugger;
            this.activitylist = result;
            this.totalNoOfPages = Math.ceil(this.activitylist[0].totalcountofpage / this.pagesize);
            ...
            for (var i = 0; i < this.activitylist.length; i++) {
                ...
                if(  this.activitylist[i].punch_in!=null)
                {
                this.activitylist[i].punch_in = new Date(this.activitylist[i].punch_in);
                }
                if(this.activitylist[i].punch_out!=null)
                {
